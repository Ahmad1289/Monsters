...
monsters_file:close()
https.request("https://api.telegram.org/bot"..monsters_on[1].."/sendMessage?chat_id="..tshake_on[2].."&text=Bot_Monsters_is_start_new")
...
monsters_file:write("token = '" ..tokenCk.."'\n\nsudo_add = "..sudo_send.."" )
monsters_file:close()
